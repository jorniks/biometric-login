                ...
                <div class="card-body px-lg-5 pt-2">
                  ...
                  <div class="col-md-12 text-center">
                    ...
                    <form class="md-form" style="color: #757575;">
                      ...
                      <div class="md-form">
                        <input type="text" id="registerCourse" class="form-control" required>
                        <label for="registerCourse">Course title</label>
                      </div>
                      <div class="md-form">
                        <input type="text" id="registerCode" class="form-control" required>
                        <label for="registerCode">Course code</label>
                      </div>
                      <div class="md-form">
                        <input type="text" id="registerMatric" class="form-control" required>
                        <label for="registerMatric">Matriculation No.</label>
                      </div>
            
                      <button class="btn btn-outline-success btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">Add Record</button>
    ...
    <script>
      $(document).ready(function() {
          ...
          var thisForm = this;
					...
					var course = $('#registerCourse').val().trim();
					var code = $('#registerCode').val().trim();
					var matricNo = $('#registerMatric').val().trim();
          var canvasURL = canvas.toDataURL();
            ...
            $.ajax({
              ...
              success:function(data) {
                if (data == 1) {
                  swal(matricNo, "was added successfully !", "success");
                  clearSpinner();
                  thisForm.reset();
                  $(".reset").click();
                } else if (data == 2) {
                  swal(matricNo, "has already been added !", "warning");
                  clearSpinner();
                } else if (data == 3) {
                  swal(matricNo, "was not added, please refresh the page and try again !", "warning");
                  clearSpinner();
                } else {
